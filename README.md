...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-rules?sort=semver)](https://github.com/liberusoftware/module-automation-rules/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-rules/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-rules/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-rules
```
...
<a href="https://github.com/liberusoftware/module-automation-rules/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-rules" alt="Contributors to liberusoftware/module-automation-rules">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-rules/graphs/contributors).
